...
INSERT INTO `cat_category` VALUES (1,2,1,'DESAYUNOS',_binary ''),(2,2,2,'ENTRADAS',_binary ''),(3,2,3,'ENSALADAS',_binary ''),(4,2,4,'PARRILLA DE CARBÓN',_binary ''),(5,2,5,'NUESTRAS PATATAS ESPECIALES',_binary ''),(6,2,6,'BEBIDAS',_binary '');
...
BEGIN   
	...
	SELECT 
        ...
        men.men_name as 'name',
        CASE WHEN (men.men_enable) THEN 1 ELSE 0 END as 'enable',
		(select count(*) from cat_category cat2 where cat2.usr_id = pUsrId) as 'categories',
        (select count(*) from pro_product pro2 where pro2.cat_id =  cat.cat_id and pro2.usr_id = pUsrId) as 'products'
	FROM men_menu  men
    WHERE
		men.usr_id = pUsrId
...
-- Dump completed on 2020-06-12 21:03:03
