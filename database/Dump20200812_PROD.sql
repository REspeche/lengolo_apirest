...
) ENGINE=InnoDB AUTO_INCREMENT=94926 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
) ENGINE=InnoDB AUTO_INCREMENT=5610 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8960 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sta_state` (
  `sta_id` int NOT NULL,
  `cou_id` int NOT NULL,
  `sta_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `sta_name` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
BEGIN
	...
	SELECT 
		...
		cat.cat_id_parent as 'catIdParent',
		cat.cat_id as 'catId',
		CASE WHEN (lisPro.men_own_style) THEN cat_name ELSE FN_REMOVE_ACCENTS(cat_name) END as 'category',
		cat.cat_manyPrices as 'colManyPrices',
		cat.cat_excerpt as 'excerptCat',
		pro_excerpt as 'excerpt',
		(pro_type+0) as 'type',
...
-- Dump completed on 2020-08-12 16:42:08
